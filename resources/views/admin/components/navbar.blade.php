            ...
            <ul class="navbar-nav align-items-center">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col ps-0 ms-2">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="text-end">
                                                <!-- Last Active Time (or a custom message) -->
                ...
                <li class="nav-item dropdown ms-lg-3"><a class="nav-link dropdown-toggle pt-1 px-0" href="#"
                        ...
                        <div class="media d-flex align-items-center"><img class="avatar rounded-circle"
                                alt="Image placeholder"  src="{{ auth()->user()->avatar ?? asset('assets/img/default-avatar.jpg') }}" >
                            <div class="media-body ms-2 text-dark align-items-center d-none d-lg-block"><span
                                    class="mb-0 font-small fw-bold text-gray-900">  <h4 class="h6 mb-0 text-small">{{ auth()->user()->name }}</h4></span></div>
                        </div>
                    </a>
