                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#editPermissionModal{{ $permission->id }}">
                                Edit
                            </button>
        ...
        <form action="{{ route('permissions.store') }}" method="POST">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="permission_title" name="permission_title" placeholder="Enter Permission Title" required>
            </div>
          </div>
            ...
            <form action="{{ route('permissions.update', $permission->id) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="edit_permission_title{{ $permission->id }}" name="permission_title" value="{{ $permission->permission_title }}" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
